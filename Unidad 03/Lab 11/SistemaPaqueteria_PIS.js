...
const diccionario = ["paquete_express", "postal_nacional", "prioritario", "estandar",
"perecedero"];
// Carga de términos
diccionario.forEach(termino => motor.insertarTermino(termino));
console.log("Diccionario de paquetería cargado exitosamente.");
2. /*Guía para la Simulación de Búsqueda: Para verificar el funcionamiento y
medir la eficiencia en el rastreo de identificadores, implemente los
siguientes scripts de prueba:
•*/
...
const motor_2 = new MotorAutocompletado();
...
diccionario_2.forEach(termino => motor_2.insertarTermino(termino));
console.log("Diccionario de paquetería cargado exitosamente en el Trie.");

console.log("--- Búsqueda Manual ---");
console.log("Sugerencias para 'p':", motor_2.obtenerSugerencias("p"));
console.log("Sugerencias para 'pa':", motor_2.obtenerSugerencias("pa"));
console.log("Sugerencias para 'pos':", motor_2.obtenerSugerencias("pos"));
...
prefijosPrueba2.forEach(prefijo => {
 ...
 const resultados = motor_2.obtenerSugerencias(prefijo);
